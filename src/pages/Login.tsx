          ...
          {isForgotPassword ? (
            ...
            >
              <div className="space-y-1">
                <h2 className="text-xl font-black text-zinc-900 dark:text-white">Reset Password</h2>
                <p className="text-xs text-zinc-500">Enter your email address and we'll send you a link to reset your password.</p>
              </div>
              ...
              <form onSubmit={handleResetPassword} className="space-y-4">
                ...
                {resetError && <p className="text-red-500 text-xs font-medium">{resetError}</p>}
                {resetSuccess && <p className="text-emerald-500 text-xs font-semibold leading-relaxed">{resetSuccess}</p>}

                <button
                  type="submit"
                  disabled={resetLoading}
                  className="w-full py-4 bg-zinc-900 dark:bg-white dark:text-zinc-900 text-white rounded-xl font-bold hover:scale-[1.02] transition-transform shadow-lg disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                >
            ...
            <>
              ...
              <button
                ...
                className="w-full py-4 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl font-bold text-sm flex items-center justify-center gap-3 hover:scale-[1.02] transition-transform disabled:opacity-50 disabled:cursor-not-allowed shadow-sm cursor-pointer"
              >
                {googleLoading ? (
