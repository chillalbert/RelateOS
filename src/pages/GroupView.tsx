...
export default function GroupView() {
 ...
 <Link to="/" className="p-2 rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-500 dark:text-zinc-400 flex-shrink-0">
 <ArrowLeft size={20} />
 </Link>
 <div>
 ...
 <div className="w-7 h-7 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 flex items-center justify-center font-black text-[10px]">
 ...
 isMe 
 ? 'bg-zinc-900 text-white dark:bg-emerald-600 dark:text-white rounded-tr-none' 
 ...
 >
 <div>
 <h3 className="text-base font-extrabold">Edit Hub Settings </h3>
