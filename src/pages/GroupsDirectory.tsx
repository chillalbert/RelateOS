...
export default function GroupsDirectory() {
 ...
 <HelpTip 
 title="What is a Hub / Friend Circle?" 
 content="Friend Circles (Hubs) are ongoing social groups where friends stay connected, answer daily social questions, and build shared Aura points. Unlike temporary Party Planning Rooms, Circles are permanent hangouts." 
 />
 </div>
 ...
 <Link 
 to="/rooms"
 className="flex items-center justify-center gap-1.5 px-4 py-2.5 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-100 rounded-full text-sm font-bold cursor-pointer transition-all hover:scale-105 border border-zinc-200 dark:border-zinc-700 flex-1 sm:flex-initial"
 >
 <span>Secret Party Rooms</span>
 </Link>
 <button 
 ...
 <div className="flex items-center justify-between pt-3.5 border-t border-zinc-100 dark:border-zinc-700">
 <div className="flex items-center gap-1 bg-zinc-50 dark:bg-zinc-950 px-2.5 py-1 rounded-xl text-[10px] font-mono font-bold tracking-wider text-zinc-400 border border-zinc-100 dark:border-zinc-700">
 ...
 <EmptyState 
 icon={Compass}
 title="No Circles or Hubs yet"
 description="Create a permanent Friend Circle for your group, or ask a friend for their invite code to join an existing Circle!"
 ...
 className="relative w-full max-w-md p-6 bg-white dark:bg-zinc-800 rounded-3xl border border-zinc-200 dark:border-zinc-700 border-t border-t-white/5 shadow-2xl dark:shadow-lg z-10 space-y-6"
 >
 <div>
